<template>
  <div class="star" :class="starType">
    <span v-for="itemClass in itemClasses" :class="itemClass" class="star-item" :key="itemClasses.index"></span>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    itemClasses () {
      let result = []
      let scoreNumber = Math.floor(this.score * 2) / 2
      let hasPoint = scoreNumber % 1 !== 0
      let integer = Math.floor(scoreNumber)
